...
# train dev split
with codecs.open('dev_data_jieba_5k.json', 'r', 'utf-8') as f:
    json_text = f.read()
...
with codecs.open('small_train_data_jieba.json', 'w', 'utf-8') as f:
    json.dump(train,f,ensure_ascii=False)

with codecs.open('samll_dev_data_jieba.json', 'w', 'utf-8') as f:
