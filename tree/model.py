...
class Model(object):
    def __init__(self, config):
        ...
        N, M, JX, JQ, VW, W, H = \
            ...
            config.max_ques_size, config.word_vocab_size, config.max_word_size, config.max_tree_height
    ...
    def _build_loss(self):
        ...
        N, M, JX, JQ, VW = \
            config.batch_size, config.max_num_sents, config.max_sent_size, \
            config.max_ques_size, config.char_vocab_size
        H = config.max_tree_height
    ...
    def get_feed_dict(self, batch, is_train, supervised=True):
        ...
        N, M, JX, JQ, VW, d, W, H = \
            config.batch_size, config.max_num_sents, config.max_sent_size, \
            config.max_ques_size,config.char_vocab_size, config.hidden_size, config.max_word_size, \
